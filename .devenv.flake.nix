{
  inputs =
    let
      version = "1.10.0";
system = "x86_64-linux";
devenv_root = "/home/shahin/sourcery/projects/hugo-scripture";
devenv_dotfile = "/home/shahin/sourcery/projects/hugo-scripture/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-c652bf0";
devenv_istesting = false;
devenv_direnvrc_latest_version = 1;
container_name = null;
active_profiles = [ ];
hostname = "lap01-dev-nix-hw";
username = "shahin";
git_root = "/home/shahin/sourcery/projects/hugo-scripture";
